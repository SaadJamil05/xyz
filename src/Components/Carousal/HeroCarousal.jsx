...
const HeroCarousal = () => {
  return (
    <div className="my-[50px] py-3 px-[100px] home_carousal bg-color1 !z-10">
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        autoplay={{
          ...
          <div className="Swiper_Slider_Box">
            ...
            <div className="Swiper_Slider_Box_right_box">
              ...
              <p>
                ...
                voluptate itaque atque, est, sed autem delectus maiores,
                laboriosam impedit harum id maxime numquam accusantium ratione.
                Nam sint magnam laboriosam quis amet dolor accusantium illo!
              </p>
